...
import com.example.user.hello_hospital.Doctor_Details.Doctor_DBManger;
...
public class MedicalHistory_Form_Activity extends AppCompatActivity {
    ...
    private String patient_doctorName,patient_details,patient_date,patient_photo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patient_photo = getIntent().getStringExtra("photo");
        ...
        if (history_rowId>0){
            ...
            secondBitmap = decodeBase64(patient_photo);
            image_View.setImageBitmap(secondBitmap);
    ...
    public void SaveData(){
       ...
       if (details.isEmpty()){
            ...
            if (history_rowId >0){
                    ...
                    MedicalHistory medicalHistory = new MedicalHistory(history_rowId,doctors_Name,details,date,mPhotoData);
                ...
                MedicalHistory medicalHistory = new MedicalHistory(doctors_Name,details,date,mPhotoData);
