...
import com.example.user.hello_hospital.MedicalHistory_Details.MedicalHistory_Form_Activity;
        ...
        if (rowId>0){
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isDeleted){
                        Toast.makeText(MainActivity.this, "Data is Deleted Successful", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(MainActivity.this,DoctorList_Activity.class));
                    }else {
                        Toast.makeText(MainActivity.this, "Data Delete Field ", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            }
